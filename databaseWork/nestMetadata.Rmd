...
**dateClutchNest**: _Character_. The date in which laying was completed for the nest (i.e., all eggs have been laid), if observed. Use the standard date format YYYY-MM-DD, for example March 15, 2016 would be provided as 2016-03-15.
...
**dateFledgeFailNest**: _Character_. The date in which the nest was observed to have fledged or failed. Use the standard date format YYYY-MM-DD, for example March 15, 2016 would be provided as 2016-03-15.

**locationNest**: _Character_. This field is based on a dropdown menu with the following choices:  
...
**nestFateExplanation**: _Character_. This is a notes field that describes the fate of the nest if the nest fate was classified as "other".
